...
describe('Happy path - Scenario 1 - Successful allocation with email notification', () => {
  test(`As a SPO allocate a case to the practitioner for 'Wales' region, 
       'Cardiff & Vale' PDU and for the 'NPS - Wrexham - Team 1' and notify other 
        practitioners by emails.  @smoke @regression @e2e @wfp-3266`, async ({ regionsPage, pduPage, 
          ...
          reviewYourAllocationNotesPage, allocateTheCasePage, caseAllocatedPage, page }, testInfo) => {
